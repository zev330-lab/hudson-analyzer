...
const LogoSVG = () => React.createElement("svg",{viewBox:"0 0 80 80",width:80,height:80,className:"mx-auto"},
  React.createElement("rect",{x:10,y:35,width:60,height:40,rx:4,fill:"#4A1942",stroke:"#D4A574",strokeWidth:2}),
  React.createElement("polygon",{points:"40,8 5,38 75,38",fill:"#4A1942",stroke:"#D4A574",strokeWidth:2}),
  React.createElement("rect",{x:30,y:50,width:20,height:25,rx:2,fill:"#D4A574",opacity:.8}),
  React.createElement("circle",{cx:58,cy:22,r:14,fill:"none",stroke:"#D4A574",strokeWidth:3}),
  React.createElement("line",{x1:68,y1:32,x2:78,y2:42,stroke:"#D4A574",strokeWidth:3,strokeLinecap:"round"}),
  React.createElement("rect",{x:18,y:45,width:8,height:8,rx:1,fill:"#D4A574",opacity:.5}),
  React.createElement("rect",{x:54,y:45,width:8,height:8,rx:1,fill:"#D4A574",opacity:.5}),
);
...
const PhoneRotateIcon = () => React.createElement("svg",{viewBox:"0 0 64 64",width:64,height:64,style:{animation:"rotatePhone 2s ease-in-out infinite"}},
  React.createElement("rect",{x:18,y:8,width:28,height:48,rx:4,fill:"none",stroke:"#D4A574",strokeWidth:2.5}),
  React.createElement("circle",{cx:32,cy:50,r:2,fill:"#D4A574"}),
  React.createElement("path",{d:"M52 32 c4-8 2-16-4-20",fill:"none",stroke:"#D4A574",strokeWidth:2,strokeLinecap:"round"}),
  React.createElement("polygon",{points:"48,10 50,16 44,14",fill:"#D4A574"}),
);
...
function RotatePrompt({onContinue}) {
  ...
  return React.createElement("div",{className:"fixed inset-0 flex flex-col items-center justify-center p-8",style:{background:"#2C0B1A",zIndex:100}},
    React.createElement(LogoSVG),
    React.createElement("h1",{className:"text-white text-2xl font-bold mt-6 mb-2 text-center"},"Hudson MA"),
...
const IntroOverlay = ({ onClose }) => {
  ...
  const pages = [
    ...
    () => React.createElement("div",{className:"fade-in"},
      ...
      React.createElement("p",{className:"text-slate-500 mb-6"},"We've analyzed 6,500+ Hudson properties and scored each for investment potential."),
  ...
  return React.createElement("div",{className:"fixed inset-0 flex items-center justify-center p-4",style:{background:"rgba(44,11,26,.9)",zIndex:90}},
...
const App = () => {
  ...
  const [starred, setStarred] = useState(() => { try { var s = JSON.parse(localStorage.getItem("hudson_starred") || "[]"); return new Set(s); } catch(e) { return new Set(); } });
  useEffect(() => { localStorage.setItem("hudson_starred", JSON.stringify([...starred])); }, [starred]);
