tailwind.config = {
  theme: {
    extend: {
      colors: {
        navy: { DEFAULT: '#4A1942', light: '#6B2D5B', dark: '#2C0B1A' },
        gold: { DEFAULT: '#D4A574', light: '#E8C9A0', dark: '#B8864A' },
...
window.__MARKET__ = {"medianPrice":588000,"avgPSF_overall":333,"avgPSF_byVillage":{"HUDSON":333},"premiumPSF_byVillage":{"HUDSON":420},"avgRentPSF":1.8,"rent2BR":2300,"rent3BR":2900,"taxRate":0.01389,"insuranceAnnual":3000,"maintenancePct":0.01,"mortgageRate":0.06,"downPaymentPct":0.25,"closingCostPct":0.03,"sellingCostPct":0.05,"renoPerSqft":85,"holdingMonths_flip":6,"vacancyRate":0.05,"medianDOM":30,"capRate_stabilized":0.05,"capRate_valueAdd":0.065,"refiLTV":0.75};
window.__STATS__ = {total: 6592, opportunities: 5035, flips: 6, holds: 541, brrrrs: 4488, valueAdds: 0};
...
const Logo = ({ size = 80, className = "" }) => React.createElement("svg", { viewBox: "0 0 64 64", width: size, height: size, className }, React.createElement("defs", null, React.createElement("linearGradient", { id: "navyGrad", x1: "0", y1: "0", x2: "1", y2: "1" }, React.createElement("stop", { offset: "0%", stopColor: "#4A1942" }), React.createElement("stop", { offset: "100%", stopColor: "#2C0B1A" })), React.createElement("linearGradient", { id: "goldGrad", x1: "0", y1: "0", x2: "0", y2: "1" }, React.createElement("stop", { offset: "0%", stopColor: "#E8C9A0" }), React.createElement("stop", { offset: "100%", stopColor: "#D4A574" }))), React.createElement("rect", { width: "64", height: "64", rx: "15", fill: "url(#navyGrad)" }), React.createElement("rect", { x: "2", y: "2", width: "60", height: "60", rx: "13", fill: "none", stroke: "#D4A574", strokeWidth: "0.5", opacity: "0.15" }), React.createElement("path", { d: "M32 11L12 24v2h40v-2L32 11z", fill: "url(#goldGrad)", opacity: "0.12" }), React.createElement("path", { d: "M12 24l20-13 20 13", stroke: "url(#goldGrad)", strokeWidth: "2.5", fill: "none", strokeLinecap: "round", strokeLinejoin: "round" }), React.createElement("path", { d: "M16 24v20h32V24", stroke: "#D4A574", strokeWidth: "1.5", fill: "none", strokeLinecap: "round", strokeLinejoin: "round", opacity: "0.6" }), React.createElement("rect", { x: "27", y: "33", width: "10", height: "11", rx: "1.5", stroke: "#D4A574", strokeWidth: "1.5", fill: "rgba(212,168,67,0.08)" }), React.createElement("circle", { cx: "35", cy: "39", r: "0.8", fill: "#D4A574" }), React.createElement("rect", { x: "19", y: "28", width: "6", height: "5", rx: "1", stroke: "#D4A574", strokeWidth: "1.2", fill: "rgba(212,168,67,0.06)" }), React.createElement("rect", { x: "39", y: "28", width: "6", height: "5", rx: "1", stroke: "#D4A574", strokeWidth: "1.2", fill: "rgba(212,168,67,0.06)" }), React.createElement("circle", { cx: "44", cy: "18", r: "6", stroke: "#D4A574", strokeWidth: "1.5", fill: "none", opacity: "0.7" }), React.createElement("circle", { cx: "44", cy: "18", r: "2", fill: "#D4A574", opacity: "0.7" }), React.createElement("path", { d: "M44 10.5v3M44 22.5v3M36.5 18h3M49.5 18h3", stroke: "#D4A574", strokeWidth: "1", strokeLinecap: "round", opacity: "0.5" }), React.createElement("path", { d: "M8 48h48", stroke: "#D4A574", strokeWidth: "1.5", strokeLinecap: "round", opacity: "0.25" }), React.createElement("path", { d: "M50 47l4-5", stroke: "#D4A574", strokeWidth: "1.5", strokeLinecap: "round", opacity: "0.5" }), React.createElement("path", { d: "M52 42h2v2", stroke: "#D4A574", strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round", opacity: "0.5" }));
...
const App = () => {
  ...
  const buildListText = (props) => {
    let txt = "Hudson MA \u2014 Property Shortlist (" + props.length + " properties)\n";
    txt += "Sent from Hudson Investment Analyzer on " + new Date().toLocaleDateString() + "\n\n";
    props.forEach((p, i) => {
  ...
  const sendListToZev = () => {
    ...
    const subject = encodeURIComponent("Hudson Investment Shortlist \u2014 " + starredProps.length + " Properties");
    ...
    if (mailtoUrl.length > 2000) {
      ...
      const shortBody = encodeURIComponent("Hudson Investment Shortlist \u2014 " + starredProps.length + " properties\n\nFull list copied to clipboard. Please paste below.\n\nProperties: " + starredProps.map((p) => p.address).join(", "));
  ...
  const downloadCSV = () => {
    ...
    a.href = url;
    a.download = "Hudson_Shortlist_" + new Date().toISOString().slice(0, 10) + ".csv";
    a.click();
  ...
  })(), React.createElement("footer", { className: "bg-navy text-slate-400 text-xs text-center py-3 mt-4 app-footer" }, "Hudson MA Investment Analysis \u00B7 Steinmetz Real Estate \u00B7 William Raveis \u00B7 Generated ", new Date().toLocaleDateString()));
};
...
setTimeout(function(){
  ...
  var g=x.createLinearGradient(0,0,s,s);g.addColorStop(0,'#4A1942');g.addColorStop(1,'#2C0B1A');x.fillStyle=g;x.fill();
  x.strokeStyle='#D4A574';x.lineWidth=2;x.lineCap='round';x.lineJoin='round';
  ...
  x.beginPath();x.arc(24,10,1.5,0,Math.PI*2);x.fillStyle='#D4A574';x.fill();
