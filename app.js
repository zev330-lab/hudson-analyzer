...
const LogoSVG = () => React.createElement("svg",{viewBox:"0 0 80 80",width:80,height:80,className:"mx-auto"},
  React.createElement("rect",{x:10,y:35,width:60,height:40,rx:4,fill:"#6B2D5B",stroke:"#D4A843",strokeWidth:2}),
  React.createElement("polygon",{points:"40,8 5,38 75,38",fill:"#6B2D5B",stroke:"#D4A843",strokeWidth:2}),
